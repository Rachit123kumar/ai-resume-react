...
export default function PersonInforPreview({resumeInfo}) {
  return (
    <div>
      ...
      <h2 className="text-center fornt-normal text-xs"style={{color:resumeInfo?.themeColor}} >{resumeInfo?.address}</h2>
